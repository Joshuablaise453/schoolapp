...
class DashboardFragment : Fragment() {
    ...
    private fun setupScrollAnimations(view: View) {
        val scrollView = view.findViewById<NestedScrollView>(R.id.dashboardScrollView)
        val contentLayout = view.findViewById<LinearLayout>(R.id.dashboardContentLayout)
